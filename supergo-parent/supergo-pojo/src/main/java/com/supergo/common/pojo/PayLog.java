...
@ApiModel(value = "payLog对象", description = "支付实体类")
public class PayLog implements Serializable {
    ...
    @ApiModelProperty(value = "支付订单号", name = "outTradeNo",required = true, dataType = "String")
    ...
    @ApiModelProperty(value = "支付完成时间", name = "payTime", dataType = "Date")
    ...
    @ApiModelProperty(value = "支付金额", name = "totalFee", dataType = "Long")
    ...
    @ApiModelProperty(value = "交易号码", name = "transactionId", dataType = "String")
    ...
    @ApiModelProperty(value = "交易状态", name = "tradeState", dataType = "String")
    ...
    @ApiModelProperty(value = "订单编号列表", name = "orderList", dataType = "String")
    ...
    @ApiModelProperty(value = "支付类型", name = "payType", dataType = "String")
