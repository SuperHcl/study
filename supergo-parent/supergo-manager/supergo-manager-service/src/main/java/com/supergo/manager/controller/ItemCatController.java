...
public class ItemCatController {
    ...
    */
    @RequestMapping("/add")
    public HttpResult add(@RequestBody(required = false) ItemCat itemCat) {
        try {
    ...
    */
    ...
    public HttpResult update(@RequestBody(required = false) ItemCat itemCat) {
        try {
    ...
    */
    ...
    public HttpResult categorysList(){
        return itemCatSerice.categorysList();
    }
