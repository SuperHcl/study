				...
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<div id="preview" class="spec-preview">
							<span class="jqzoom">
								<#if itemImageList??>
									<#--<img width="400" height="400" jqimg="${itemImageList[0].url}" src="${itemImageList[0].url}" />-->
								</#if>
							</span>
						</div>
						<!--下方的缩略图-->
										...
										<#list spec.attributeValue as item>
											<dd>
												<a href="javascript:void(0)"
												   @click="selectSpecification('${spec.attributeName}','${item}')"
